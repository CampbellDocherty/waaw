    ...
    <div className="star-builder" style={{ display: 'none' }}>
      <div className="star-builder-row">
        ...
        <div className="star-builder-options" data-group="spikes">
          ...
          <button data-value="5" className="selected">5</button>
      ...
      <div className="star-builder-row">
        ...
        <div className="star-builder-options" data-group="length">
          ...
          <button data-value="15" className="selected">3</button>
      ...
      <div className="star-builder-row">
        ...
        <div className="star-builder-options" data-group="colour">
          <button data-value="#F8FF6E" style={{ backgroundColor: '#F8FF6E' }}></button>
          <button data-value="#F875FC" style={{ backgroundColor: '#F875FC' }}></button>
          <button data-value="#F927FF" style={{ backgroundColor: '#F927FF' }}></button>
          <button data-value="white" className="selected" style={{ backgroundColor: 'white' }}></button>
          <button data-value="#803EFF" style={{ backgroundColor: '#803EFF' }}></button>
          <button data-value="#4200AA" style={{ backgroundColor: '#4200AA' }}></button>
        </div>
      </div>
      <div className="star-builder-row">
        <span className="star-builder-label">Name</span>
        <input type="text" className="star-builder-name" placeholder="Enter name" maxLength={12} />
      </div>
